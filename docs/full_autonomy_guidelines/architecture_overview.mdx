...
We currently provide full autonomy for Unitree Go2 through the BrainPack. Learn more abour it ![here](../brainpack_introduction).

## System Architecture
1. Sensor Data Collection
    The unitree_sdk gathers data from sensors such as LiDAR and cameras, publishing ROS2 topics for localization and mapping.
...
4. User Interaction
    The om1-avatar frontend displays robot avatars, allowing you to interact with your robot in real time via the BrainPack screen. It is designed to work in conjunction with OM1 robotics backend systems and hardware components.
